...
export class News extends Component {
    ...
    constructor(props) {
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)} - BKnews`;
    }
    ...
    render() {
        return (
            <>
                <h1 className="text-center" style={{ margin: '35px 0px', marginTop:'90px' }}>BKnews - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
